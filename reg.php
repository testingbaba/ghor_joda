...
$mother=$_POST["mothername"];                                      //mothername (mothername)

$date=$_POST["dob"];                                             //Date of Birth(dob)
...
try {
 ...
 //   $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
    ...
    $mail->Subject = 'Regestation';
    $mail->Body    = "Name: $name <br>Email: $email<br>Father Name: $father<br>Mother Name: $mother<br>Age:  $age<br>Gender:
    $gender<br>Address:  $address<br>Country: $country<br>DOB: $date<br>Subject: $subject<br> Thank You";
